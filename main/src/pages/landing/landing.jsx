        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/menu" className="text-white hover:text-green-200">
                Menu
              </Link>
            ...
            <Link
              to="/products"
              className=" px-6 py-2 rounded-full hover:bg-green-50 transition-colors"
            ></Link>
          </div>
        </div>
      </nav>
            ...
            <div className="bg-green-600 flex items-center px-12 lg:px-24">
              <div className="max-w-xl">
                ...
                <p className="text-green-50 text-lg mb-8">
                  ...
                  carefully crafted meals, made from the freshest ingredients
                  and delivered right to your doorstep.
                </p>
                <div className="flex space-x-4">
                  <Link
                    to="/products"
                    className="bg-white text-green-600 px-8 py-3 rounded-full hover:bg-green-50 transition-colors"
                  >
                    Order Now
                  </Link>
                  <Link
                    to="/vendors"
                    className="border-2 border-white text-white px-8 py-3 rounded-full hover:bg-green-700 transition-colors"
                  >
                    Be a Vendor
                  </Link>
                </div>
